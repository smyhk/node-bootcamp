...
var stripe = Stripe('pk_test_51HpJoRLyrkAPfDunr9LyZkDwjxJB1Tjspl4f2WeqVfUU5gV7w1gDU6XvFSIqFsRLqwPLl5qC7uqSkGhtkdd6g6TE000iOhvHOk');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form + process + charge credid card
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic215aGsiLCJhIjoiY2tnY3BwMXhvMGdudzJ6cDR1dGw0cGJ0ZiJ9.MLlEfcgHWa4Kdx6_adYkhA';
...
var userPasswordForm = document.querySelector('.form-user-password'); // Delegation - only execute if these elements exist
